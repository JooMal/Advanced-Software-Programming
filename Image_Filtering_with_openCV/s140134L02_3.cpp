...
void sobelfilter(int kernelsize, void *userData);
...
void sobelfilter(int kernelsize, void *userData)
{
	...
	cv::Sobel(input_im, dst, -1, 1, 1, value);
...
int main(int argc, char *argv[])
{
	...
	string window_name = "Sobel Filter Image Window s140134";
	...
	cv::createTrackbar("KernelSize", window_name, &start_value, max_value, sobelfilter, static_cast<void*>(&window_name));
